                ...
                <div class="panel-body">
                   ...
                   {{ method_field('PATCH') }}
						...
						<div class="form-group form-inline">
							...
							<textarea name="profile" class="form-control" id="profile">{{$village->profile}}</textarea>
						</div>
						<div class="form-group form-inline">
							<label for="education" class="col-sm-2">Education Level in village: </label>
							<textarea name="education" class="form-control" id="education">{{$village->education}}</textarea>
						</div>
						<div class="form-group form-inline">
